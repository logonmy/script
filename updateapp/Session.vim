...
nnoremap \tl : Tlist
nmap <silent> \C :call CapitalCenterAndMoveDown()
let s:cpo_save=&cpo
set cpo&vim
...
set mouse=v
set ruler
set runtimepath=~/.vim,~/.vim/bundle/c-support,~/.vim/bundle/command-t,~/.vim/bundle/doc,~/.vim/bundle/ftplugin,~/.vim/bundle/hotkeys.latex,~/.vim/bundle/nerdtree,~/.vim/bundle/plugin,~/.vim/bundle/taglist.vim,~/.vim/bundle/vim-powerline,~/.vim/bundle/visualmark,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/after
set tabstop=4
set tags=~/mcp/mcp/trunk/tags;
...
set shortmess=aoO
badd +0 ~/updateapp/updateApp.php
args updateApp.php
edit ~/updateapp/updateApp.php
...
406
normal zc
let s:l = 176 - ((0 * winheight(0) + 17) / 35)
